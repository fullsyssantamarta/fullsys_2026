...
class CreditNoteResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Nota Crédito';
    
    protected static ?string $pluralModelLabel = 'Notas Crédito';
        ...
        return $form
            ->schema([
                ...
                Section::make('Factura Original')
                    ->description('Seleccione la factura a la que se le aplicará la nota crédito')
                    ->schema([
                ...
                Section::make('Información de la Nota Crédito')
                    ->schema([
                        ...
                        Select::make('resolution_id')
                            ...
                            ->options(Resolution::query()
                                ->where('type_document_id', 91) // Nota Crédito
                ...
                Section::make('Motivo de la Nota Crédito')
                    ->description('Indique el motivo de la emisión de esta nota crédito')
                    ->schema([
                        Select::make('discrepancy_response_code')
                            ->label('Código de Motivo')
                            ->options(DiscrepancyCode::getCreditNoteCodes())
                            ->required()
                            ->reactive()
                            ->columnSpan(2),
                ...
                // Sección 4: Ítems de la Nota Crédito
                Section::make('Ítems')
                    ->schema([
                        Repeater::make('items')
                            ->relationship()
        ...
        return $table
            ...
            ->actions([
                ...
                Tables\Actions\EditAction::make()
                    ->visible(fn(CreditNote $record) => $record->is_draft),
            ])
            ->bulkActions([
