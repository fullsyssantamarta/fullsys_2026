...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('credit_notes', function (Blueprint $table) {
            ...
            $table->unsignedInteger('type_document_id')->default(91); // 91 = Nota Crédito
            ...
            $table->string('discrepancy_response_code', 10); // 1=Intereses, 2=Devolución, 3=Descuento, etc
            ...
            // Respuesta DIAN
            $table->string('cude', 500)->nullable(); // Código Único Nota Crédito
